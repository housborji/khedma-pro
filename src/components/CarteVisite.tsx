    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="bg-gradient-to-b from-[#dbe2e8] to-[#a4c4e8] pb-8">
        ...
        <div className="relative text-center">
          ...
          {/* Badge « Mawjoud » */}
          <div className="absolute top-5 left-5 bg-[#1b4282] text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
            Disponible
          </div>
        ...
        {/* Boutons ronds (sans SMS, avec Instagram si présent) */}
        ...
        <div className="bg-white rounded-[20px] p-5 shadow-md">
          <div className="flex items-center mb-4">
            <div className="w-10 h-10 bg-black text-white rounded-[10px] flex justify-center items-center mr-4 text-lg">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79..."/></svg>
            </div>
          ...
          <div className="flex justify-between items-center mt-5">
            <div className="flex gap-2.5">
              <a href={`/api/qr/${client.id}`} target="_blank" rel="noopener noreferrer"
                className="w-[45px] h-[45px] bg-[#1b4282] text-white rounded-full flex justify-center items-center text-lg shadow-md hover:scale-105 transition-transform">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 11h8V3H3v8zm2-6h4v4H5V5zm8-2v8h8V3h-8zm6 6h-4V5h4v4zM3 21h8v-8H3v8zm2-6h4v4H5v-4zm13-2h-2v3h3v2h-3v2h-2v-3h-2v-2h2v-2h3v2zm-1-1h-2v-2h2v2z"/></svg>
              </a>
              <button onClick={() => navigator.share ? navigator.share({ url: window.location.href }) : navigator.clipboard.writeText(window.location.href)}
                className="w-[45px] h-[45px] bg-[#1b4282] text-white rounded-full flex justify-center items-center text-lg shadow-md hover:scale-105 transition-transform">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18 16.08c-.76..."/></svg>
              </button>
            </div>
