...
export default function CarteVisite({ client }: { client: Client }) {
  ...
  return (
    <div className="min-h-screen bg-black flex justify-center items-center p-4">
      {/* Conteneur téléphone */}
      <div className="w-full max-w-[390px] bg-gradient-to-b from-[#dbe2e8] to-[#a4c4e8] rounded-[40px] overflow-hidden relative shadow-[0_0_15px_rgba(255,255,255,0.2)] border-[6px] border-[#e0e0e0] min-h-[844px]">
        
        {/* Dynamic Island */}
        <div className="w-[120px] h-[35px] bg-black rounded-[20px] absolute top-[10px] left-1/2 -translate-x-1/2 z-10" />
        ...
        <div className="relative text-center">
          ...
          <div className="absolute bottom-5 left-5 text-left">
            <h1 className="text-[32px] font-normal text-white mb-1" style={{ textShadow: "1px 1px 4px rgba(0,0,0,0.4)" }}>
              {client.nom.split(" ")[0]}
            </h1>
        ...
        {/* Boutons d'actions ronds */}
        <div className="flex justify-start gap-[15px] px-5 -mt-2.5">
          {/* Téléphone */}
          <a
            href={`tel:${client.telephone}`}
            className="w-[45px] h-[45px] bg-[#1b4282] text-white rounded-full flex justify-center items-center text-lg shadow-[0_4px_6px_rgba(0,0,0,0.1)] hover:scale-105 transition-transform"
          >
        ...
        {/* Carte Contact */}
        <div className="bg-white mx-5 mt-[25px] rounded-[20px] p-5 shadow-[0_4px_10px_rgba(0,0,0,0.05)]">
          <div className="flex items-center mb-[15px]">
            <div className="w-10 h-10 bg-black text-white rounded-[10px] flex justify-center items-center mr-[15px] text-lg">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24 11.36 11.36 0 003.58.57 1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1 11.36 11.36 0 00.57 3.58 1 1 0 01-.25 1.01l-2.2 2.2z" />
              </svg>
            </div>
          ...
          <hr className="border-t border-dashed border-[#ccc] my-[15px]" />
