...
export default function CarteVisite({ client }: { client: Client }) {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Partie haute avec dégradé (comme l'écran du téléphone) */}
      ...
      {/* Carte Contact (pleine largeur, fond noir) */}
      <div className="bg-black px-5 pt-6 pb-8">
        <div className="bg-white rounded-[20px] p-5 shadow-[0_4px_10px_rgba(0,0,0,0.05)]">
